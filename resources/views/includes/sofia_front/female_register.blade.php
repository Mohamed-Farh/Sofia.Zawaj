            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <form action="{{ route('member_register') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="gender" value="أنثي">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4">
                                    <select name="body_status" required
                                        class="form-control custom-select selectpicker gender">
                                        <option value=""> {{ __('-') }} </option>
                                        <option value="نحيفة">نحيفة</option>
                                        <option value="متوسطة">متوسطة</option>
                                        <option value="رياضية">رياضية</option>
                                        <option value="سمينة">سمينة</option>
                                        <option value="ضخمة">ضخمة</option>
                                    </select>
                                </div>
                            </div>
