        ...
        <div class="container">
            <div class="row">
                <div class="col search-result-col">
                    <h3>{{ $member->name }}</h3>
                    <p>تاريخ الإنضمام: {{ \Carbon\Carbon::parse($member->created_at)->translatedFormat('l j F Y H:i') }}</p><br>
                    <p>اخر ظهور: {{ \Carbon\Carbon::parse($member->last_seen)->translatedFormat('l j F Y H:i') }}</p>
                </div>
            </div>
        </div>
    </div>
