                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 mt-2">
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6  col-md-6 col-lg-4 mt-2">
                                        <img src="{{ asset('app-assets/images/Group 27801.png') }}"><a href="{{ route('latest_members') }}" class="link-result-1">الكل</a>
                                    </div>
                                    <div class="col-xs-6 col-sm-6  col-md-6 col-lg-4 mt-2">
                                        <img src="{{ asset('app-assets/images/Group 278011.png') }}"><a href="{{ route('latest_males') }}" class="link-result-1">ذكر</a>
                                    </div>
                                    <div class="col-xs-6 col-sm-6  col-md-6 col-lg-4 mt-2">
                                        <img src="{{ asset('app-assets/images/Group 2780111.png') }}"><a href="{{ route('latest_females') }}" class="link-result-1">انثى</a>
                                    </div>
                                </div>
                            </div>
                        </div>
