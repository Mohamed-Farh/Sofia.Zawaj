                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    ...
                    {!! Form::open(['route' => 'front_members_full_filter_search', 'method' => 'get']) !!}
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                <select name="first_nationality" required class="form-control custom-select selectpicker gender">
                                    ...
                                    @forelse ($all_countries as $country)
                                        <option value="{{ $country->name }}" {{ old('nationality') == $country->name ? 'selected' : null }}>{{ $country->name }}</option>
                                    @empty
                                    @endforelse
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                <select name="country" id="country" required class="form-control custom-select selectpicker gender">
                                    <option value="0">{{__("اختر---") }}</option>
                                    <option value="" style="background-color: grey; color:white"  disabled>{{__("الوطن العربي") }}</option>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                <select name="city" id="city" class="form-control custom-select selectpicker gender">
                                </select>
                            </div>
                        </div>
