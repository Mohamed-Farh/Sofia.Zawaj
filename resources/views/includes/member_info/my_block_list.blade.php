        ...
        <div class="container container-1">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 all-result-sec">
                    ...
                    <div class="row">
                        @if ($members_counts != '0')
                            @foreach ($members as $member_block)
                                <?php  $member =\App\Models\Member::where('id', $member_block->member_id)->first(); ?>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 mt-3">
                                    <div class="card" style="width: 100%">
                                        ...
                                        <div class="row media-body iconsInThree">
                                                ...
                                                @if (Auth::guard('member')->check())
                                                    ...
                                                    @if ($relation)
                                                        <button data-toggle="modal" data-target="#care{{ $member->id }}"
                                                            class="like" title="يجب فك الحظر لالغاء اعجابك" style="color: #ff8c6a;">
                                                            <i class="fas fa-heart"></i>
                                                        </button>
                                                    @else
                                                        <button data-toggle="modal" data-target="#care{{ $member->id }}"
                                                            class="like" title="يجب فك الحظر لتسجيل اعجابك" style="color: #ff8c6a;">
                                            ...
                                            <div class="col-3">
                                                <button data-toggle="modal" data-target="#block{{ $member->id }}" class="block" title="الغاء الحظر" style="color: #ff8c6a;">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('member_block', 'test') }}" method="post">
                                                    {{ method_field('post') }}
                                                    @csrf
                                                    {{ __('هـل أنـت مـتـأكـد مـن الـغـاء حـظـر هـذا الـعـضـو') }}
