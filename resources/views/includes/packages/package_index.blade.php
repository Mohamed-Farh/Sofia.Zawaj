        ...
        <div class="container">
            <div class="row">
                <div class="col search-result-col">
                    <h3>باقات التمييز</h3>
                    <p>انضم الآن واحصل على المزايا والعروض من صوفيا</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 all-result-sec">
                    ...
                    <div class="row mt-2 card-pakage">
                        @if ($packages_counts != '0')
                            @foreach ($packages as $package)
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 mt-2">
                                    <a href="/package/front_package_features/{{ $package->id }}">
                                        <div class="card s" style="width: 100%;border: 2px solid #FF7B54;">
                                            ...
                                            <p style="text-align: center; font-size: 15px;padding-bottom: 10px;">( {{ $package->price }} ) دولار</p>
                                        </div>
                                    </a>
                                </div>
                            @endforeach
                        @else
                            <div class="col" style="text-align: center">
                                <h3 style="text-align: center">عفوا لا يوجد باقات في هذة القائمة</h3>
                            </div>
                        @endif
