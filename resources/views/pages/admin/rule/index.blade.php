                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- add_form -->
                                            <form action="{{ route('rule.update', 'test') }}" method="post">
                                                {{ method_field('patch') }}
                                                @csrf
                                                ...
                                                <div class="form-group modual_space">
                                                    <div class="col">
                                                        ...
                                                        <textarea class="form-control" name="name" rows="10" style="    line-height: 30px;">{{ $privacy_rule->name }}</textarea>
                                                    </div>
                                                </div>
                            ...
                            <div class="modal fade" id="vis_privacy_rule{{ $privacy_rule->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- add_form -->
                                            <form action="{{ route('show_rule/visible', 'test') }}" method="post">
                                                {{ method_field('post') }}
                                                @csrf
                                                    @if  ($privacy_rule->status == '1')
                            ...
                            <div class="modal fade" id="delete{{ $privacy_rule->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('rule.destroy', 'test') }}" method="post">
                                                {{ method_field('Delete') }}
                                                @csrf
                                                    {{__('هـل أنـت مـتـأكـد مـن هـذه الـعـمـلـبـة')}}
                                                <input id="id" type="hidden" name="id" class="form-control"
