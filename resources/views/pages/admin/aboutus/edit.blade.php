                        ...
                        <div class="row beauty_top">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('aboutus', old('aboutus', $aboutus->aboutus ), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="row beauty_top">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('why_us', old('why_us', $aboutus->why_us ), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="row beauty">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('safe', old('safe', $aboutus->safe ), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="row beauty">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('smart', old('smart', $aboutus->smart ), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="row beauty">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('secret', old('secret', $aboutus->secret ), ['class' => 'form-control summernote']) !!}
